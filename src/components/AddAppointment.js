...
export default function AddAppointment({ onSendAppointment, lastId }) {
  ...
  // Set a single state to the object so multiple references can be manipulated,
  // without a state for each element in the form.
  const [formData, setFormData] = useState(clearData);

  // Fill the object with the input form data
  const formDataPublish = () => {
    ...
    // Simulating a POST request. Work visually on the UI.
